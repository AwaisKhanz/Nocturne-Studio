...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition focus-visible:outline-none focus-visible:ring-2 theme-ring disabled:pointer-events-none disabled:opacity-50 transition-transform hover:-translate-y-0.5 active:translate-y-0 theme-transition-colors",
  {
    variants: {
      variant: {
        default:
